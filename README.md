...
### Note
For this frontend to work you'll need the backend/api section -> https://github.com/carlosasjr/ev-charge-map-api

You'll need to install the Quasar CLI tool -> https://quasar.dev/start/pick-quasar-flavour

Clone the repository
```
git clone https://github.com/carlosasjr/ev-charge-map.git
```
